...
public class dat2bmp {
	...
	public static void main (String [] args) throws IOException {
		...
		for (int z=0; z<num_sprites; z++) {
			...
			OutputStream out = new BufferedOutputStream(new FileOutputStream(new File("output\\sprites\\"+sprite_data[z][1]+"_"+sprite_data[z][2]+"_"+z+".A.bmp")));
			...
			if (size != 0) {
				...
				out = new BufferedOutputStream(new FileOutputStream(new File("output\\shadows\\"+filename+"_"+z+".B.bmp")));
				out.write(bmp_header);
			...
			if (size != 0) {
				...
				out = new BufferedOutputStream(new FileOutputStream(new File("output\\shadows\\"+filename+"_"+z+".C.bmp")));
				out.write(bmp_header);
				out.write(bitmap);
				out.close();
			}
